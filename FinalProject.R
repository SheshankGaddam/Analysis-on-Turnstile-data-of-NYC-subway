DATASET: "https://raw.githubusercontent.com/buswedg/Udacity/master/Data%20Analyst%20Nanodegree/P2%20Analyzing%20the%20NYC%20Subway%20Dataset/data/turnstile_weather_v2.csv"

Other website for Project code: https://jameskao.me/analyzing-the-nyc-subway-dataset/


https://raw.githubusercontent.com/nupur1492/RProjects/master/MachineLearning/turnstile_data_master_with_weather.csv

df_turnstile <- read.csv("https://raw.githubusercontent.com/nupur1492/RProjects/master/MachineLearning/turnstile_data_master_with_weather.csv")
str(df_turnstile)
...
```{r}
df_turnstile <- read.csv("https://raw.githubusercontent.com/buswedg/Udacity/master/Data%20Analyst%20Nanodegree/P2%20Analyzing%20the%20NYC%20Subway%20Dataset/data/turnstile_weather_v2.csv")
str(df_turnstile)
```
